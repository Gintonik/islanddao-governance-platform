/**
 * Accurate VSR Governance Calculator
 * Takes the maximum governance power value from each VSR account (not sum of offsets)
 * Properly aggregates across all VSR accounts for each wallet
 */
