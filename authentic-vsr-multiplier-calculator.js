...
function calculateAuthenticMultiplier(lockup, now = Date.now() / 1000) {
  ...
  // Based on Takisoul's real data:
  // 3,682,784.632186 ISLAND with 1.35x multiplier and ~42 days remaining (1m 12d)
  // This suggests the multiplier formula is much simpler than we thought
  ...
  if (daysRemaining > 365) {
    ...
    return 1.35; // 3+ month lockups (matches Takisoul's 1.35x)
  } else if (daysRemaining > 30) {
    return 1.25; // 1+ month lockups
